...
<body style="width:100%; height:100%"
    class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-aside--enabled kt-aside--fixed kt-page--loading @yield('subHeaderClass','')  @yield('minimizarAside','')">
    <header>
        <nav class=" position-sticky navbar navbar-expand-lg navbar-light bg-dark  fixed-top" ">
    <div class=" container-fluid">
            <div class="collapse navbar-collapse" id="navbarExample01">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <svg style=" fill: rgb(207,255,237);" xmlns="http://www.w3.org/2000/svg" width="50" height="50"
                    ...
                    <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start"
                        ...
                        <li class="nav-item">
                            <a href="{{route('inicio')}}" class="nav-link align-middle px-0">
                                <i class="fs-4 bi-house"></i> <span class="ms-1 d-none d-sm-inline text-light">Cerrar
                                    Sesión </span>
                            </a>
                        </li>
                    </ul>
