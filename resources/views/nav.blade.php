...
<nav class="navbar navbar-expand-lg navbar-light  pt-5">
    <svg xmlns="http://www.w3.org/2000/svg" class="offset-2" width="50" height="50" version="1.0" viewBox="0 0 500 500">
        <path
    ...
    <a class="navbar-brand col-4 " href="{{route('inicio')}}">Veterinaria patitas</a>
