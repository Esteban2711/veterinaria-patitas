                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('loginSubmit') }}">
                                    ...
                                    <div class="form-group row">
                                        <label
                                            class="col-form-label text-sm-right font-weight-bold text-dark">Usuario</label>
                                        <input type="text" class="form-control  " value="admin"
                                            placeholder="Ingrese la el usuario" name="usuario" tabindex="-1" required>
                                    </div>
                                    <div class="form-group row pt-4">
                                        <label
                                            class="col-form-label text-sm-right font-weight-bold text-dark">Contraseña</label>
                                        <input type="password" class="form-control  " value="admin"
                                            placeholder="Ingrese el contraseña" required name="contraseña"
                                            tabindex="-1">
                                    </div>
                                    @if($errors)
                                    @if($errors->any())
                                    ...
                                    <div class="form-group row pt-3">
                                        <div
                                            class="col-lg-4 col-sm-4 col-xs-4 offset-lg-4 offset-sm-5 offset-xs-4 text-center">
